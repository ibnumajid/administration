...
// Backend untuk memasukkan surat ke dalam databse 1
                        ...
                        <script>history.pushState({}, "", "")</script><?php
                          ...
                          $query = mysqli_query($koneksi, "INSERT into suratdosen values('', '2', '$nama_dsn','$id_npp','$perihal', '$keterangan', '$nama_barang', '$jumlah_barang', '$nama_lab', '$tgl_pel1', '$tgl_pel2', '', '', '0', '0', '$ukuran', '$tipe', '0', '$url', '', '',  '', '', '', '',   sysdate(), '') ");
