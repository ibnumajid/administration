...
<div class="container-fluid py-4">
      <div class="row">
        ...
        <a href="./validasisurat0.php" id='failedList'><button class = "btn btn-info">Menunggu Persetujuan</button></a>
   ...
   ?>
                  ...
                  <?php 
                    if ($_SESSION['status'] == 5 && $data['status_kadep'] == 0){ ?>
                        ...
                        else if ($_SESSION['status'] == 2 && strpos($nama, $tujuan) !== false && $data['status_surat'] == 0) {
                          ?> 
