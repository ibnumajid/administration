...
?><script>
    ...
    <?php header("location:bimbingansurat.php");
    }
  } else {
    ?><script>
                      ...
                      <div class="mb-3">
                        <div class="row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="hidden" name="nrp" value="<?php echo $data['id_nrp'] ?>">
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <br>
                          <div class="form-group"><input name="catatan" class="form-control" type="text"></div>
                        </div>
                        <?php } ?>
                      </div>
                    </div>
