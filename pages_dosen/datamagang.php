          ...
          <div class="card mb-4">               
            ...
            <div class="table-responsive scrollbar-deep-purple bordered-deep-purple thin mt-0 pt-0" style = "height:530px" >
                <table class="table align-items-center mb-0">
                  ...
                  $query = mysqli_query($koneksi, "SELECT * FROM suratmahasiswa WHERE status_admin = '2' ");
                  $no = 0;
                  $no2 = $no++;
                  while ($data = mysqli_fetch_array($query)) {
                      if ($data['perihal'] == "Surat Magang") {
                       $nrp = $data['id_nrp'];
                      $query_mhs = mysqli_query($koneksi, "SELECT * FROM data_mhs where nrp_mhs = '$nrp' ");
                     while ($data2 = mysqli_fetch_assoc($query_mhs)) { ?> 
                  ...
                  <!-- nama -->
                    <td style = "height:20px">
                      ...
                      <!-- nrp -->
                      <td>
                      <h6 class="mb-0 text-sm text-center"><?php echo $data2['nrp_mhs'] ?></h6>
                      </td>
                      <!-- progres -->
                      <td>
                        <h6 class="mb-0 text-sm ps-3"><?php echo $data['keterangan'] ?></h6>
                      </td>
