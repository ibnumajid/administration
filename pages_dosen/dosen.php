...
<?php if ($_SESSION['status2'] == 5) { ?>
    ...
    <div class="card">
      ...
      <iframe src="https://administration.cypiral.org/pages_dosen/tabel/suratmasukkadep.php" frameborder="0" style = "height:500px"></iframe>
...
<!-- surat masuk sebagai dosen -->
  <div class="row">
   ...
   <h6 class="mb-0 mx-2 mt-2 pt-1 px-1">Surat Masuk Sebagai Dosen</h6>
     <iframe src="https://administration.cypiral.org/pages_dosen/tabel/suratmasukdosen.php" frameborder="0" style = "height:500px"></iframe>
