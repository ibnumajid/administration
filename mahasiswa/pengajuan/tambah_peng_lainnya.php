<?php include('../_database/config.php'); ?>
		...
		<center><font size="6">Tambah Pengajuan Lainnya </font></center>
		<hr>
		<?php
		if(isset($_POST['submit'])){
			...
			if($sql){
					echo '<script>alert("Berhasil menambahkan data."); document.location="mahasiswa/permohonan/tampil_lainnya.php";</script>';
				}else{
