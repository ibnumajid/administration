...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Pengajuan Tugas Akhir</font></center>
		<hr>
		<a href="mahasiswa.php?page=tambah_peng_tugasakhir"><button class="btn btn-dark right">Tambah Data</button></a>
