<?php include('../_database/config.php'); ?>
		...
		<center><font size="6">Tambah Bimbingan Tugas Akhir</font></center>
		<hr>
		<?php
		...
		<form action="mahasiswa.php?page=tambah_bim_tugasakhir" method="post" enctype="multipart/form-data">
