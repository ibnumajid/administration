<?php include('../_database/config.php'); ?>
		...
		<center><font size="6">Tambah Bimbingan Magang</font></center>
		<hr>
		<?php
		...
		<form action="mahasiswa.php?page=tambah_bim_magang" method="post" enctype="multipart/form-data">
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">NRP Ketua</label>
				<div class="col-md-6 col-sm-6 ">
					<input type="text" name="pemohon" class="form-control" size="4" value=<?=$_SESSION['NIP']?> readonly required>
				</div>
			</div>
			<div class="item form-group">
				<label class="col-form-label col-md-3 col-sm-3 label-align">Nama Ketua</label>
				<div class="col-md-6 col-sm-6 ">
			...
			<div class="item form-group" >
				<label class="col-form-label col-md-3 col-sm-3 label-align">Tanggal Pelaksanaan</label>
				<div class="col-md-6 col-sm-6 ">
					<input type="text" name="keperluan" class="form-control" size="4"  required>
				</div>
			</div>
