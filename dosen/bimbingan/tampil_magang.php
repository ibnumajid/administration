...
?>
	...
	<div class="container" style="margin-top:20px">
		<center><font size="6">Magang</font></center>
		<hr>
			...
			<tbody>
				...
				while($data = mysqli_fetch_array($sql_mahasiswa)){ ?>
						<tr>
							...
							?></td>
							<td>
								<a class="edit" href="admin.php?page=edit_dsn&Nim=<?php echo $data['mhs_nrp']; ?>">Edit</a> |
								<a class="hapus" href="admin.php?page=delete_dsn&Nim=<?php echo $data['mhs_nrp']; ?>">Hapus</a>				
							</td>
							</tr>
					<?php
					}
