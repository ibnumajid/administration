...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/dteo.png" type="image/ico" />
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="assets/images/dteo.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li><a href="dosen.php"><i class="fa fa-home"></i> Home <span class="fa fa-home"></span></a>
                  </li>
              ...
              <ul class=" navbar-right">
                <li class="nav-item dropdown open" >
                  <a href="#" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown" data-toggle="dropdown" aria-expanded="false">
                    <img src="assets/images/dteo.png" alt="">Dosen
                  </a>
