...
$nama = $_SESSION['user'];
$query = mysqli_query($koneksi, "SELECT * FROM bimbingan WHERE id_no = '$id' ");
...
<!-- php update file bimbingan -->
 <?php
        ...
        if (isset($_POST['updatekdp'])) {
          ...
          $query = mysqli_query($koneksi, "UPDATE bimbinganSET `file` = '$url' WHERE id_no = '$id' ");
          $query2 = mysqli_query($koneksi, "UPDATE bimbingan SET `status_kadep` = '0' WHERE id_no = '$id' ");
